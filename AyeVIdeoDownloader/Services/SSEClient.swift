...
// Plain nonisolated struct — safe to decode in any concurrency context
...
class SSEClient: ObservableObject {
    ...
    func connect(jobId: String, token: String, onEvent: @escaping @Sendable (DownloadProgress?, String?) -> Void) {
